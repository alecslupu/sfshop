...
abstract class BaseBasketProductPeer {
	...
	const TABLE_NAME = 'basket_product';

	
	const CLASS_DEFAULT = 'plugins.sfsBasketPlugin.lib.model.BasketProduct';
	...
	const ID = 'basket_product.ID';

	
	const BASKET_ID = 'basket_product.BASKET_ID';

	
	const PRODUCT_ID = 'basket_product.PRODUCT_ID';

	
	const OPTIONS_LIST = 'basket_product.OPTIONS_LIST';

	
	const QUANTITY = 'basket_product.QUANTITY';

	
	const CREATED_AT = 'basket_product.CREATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'BasketId', 'ProductId', 'OptionsList', 'Quantity', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (BasketProductPeer::ID, BasketProductPeer::BASKET_ID, BasketProductPeer::PRODUCT_ID, BasketProductPeer::OPTIONS_LIST, BasketProductPeer::QUANTITY, BasketProductPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'basket_id', 'product_id', 'options_list', 'quantity', 'created_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'BasketId' => 1, 'ProductId' => 2, 'OptionsList' => 3, 'Quantity' => 4, 'CreatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (BasketProductPeer::ID => 0, BasketProductPeer::BASKET_ID => 1, BasketProductPeer::PRODUCT_ID => 2, BasketProductPeer::OPTIONS_LIST => 3, BasketProductPeer::QUANTITY => 4, BasketProductPeer::CREATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'basket_id' => 1, 'product_id' => 2, 'options_list' => 3, 'quantity' => 4, 'created_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsBasketPlugin.lib.model.map.BasketProductMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(BasketProductPeer::OPTIONS_LIST);
	...
	const COUNT = 'COUNT(basket_product.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT basket_product.ID)';
    ...
    foreach (sfMixer::getCallables('BaseBasketProductPeer:doSelectRS:doSelectRS') as $callable)
    {
      call_user_func($callable, 'BaseBasketProductPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseBasketProductPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseBasketProductPeer', $c, $con);
    }
		...
		$startcol = (BasketProductPeer::NUM_COLUMNS - BasketProductPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getBasket(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addBasketProduct($obj1); 					break;
				}
			}
			if ($newObject) {
    ...
    foreach (sfMixer::getCallables('BaseBasketProductPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseBasketProductPeer', $c, $con);
    }
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				$temp_obj3 = $temp_obj1->getProduct(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addBasketProduct($obj1); 					break;
				}
			}
    ...
    foreach (sfMixer::getCallables('BaseBasketProductPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseBasketProductPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseBasketProductPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		$criteria->remove(BasketProductPeer::ID); 
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof BasketProduct) {
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('plugins.sfsBasketPlugin.lib.model.map.BasketProductMapBuilder');
}
