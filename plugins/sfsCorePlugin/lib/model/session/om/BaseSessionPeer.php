...
abstract class BaseSessionPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (SessionPeer::CID, SessionPeer::SES_DATA, SessionPeer::SES_TIME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (SessionPeer::CID => 0, SessionPeer::SES_DATA => 1, SessionPeer::SES_TIME => 2, ),
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsCorePlugin.lib.model.session.map.SessionMapBuilder');
	}
	...
	const COUNT = 'COUNT(session.CID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT session.CID)';
    ...
    foreach (sfMixer::getCallables('BaseSessionPeer:doSelectRS:doSelectRS') as $callable)
    {
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Session) {
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('plugins.sfsCorePlugin.lib.model.session.map.SessionMapBuilder');
}
