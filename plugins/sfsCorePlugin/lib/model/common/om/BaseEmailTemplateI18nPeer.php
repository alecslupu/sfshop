...
abstract class BaseEmailTemplateI18nPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (EmailTemplateI18nPeer::ID, EmailTemplateI18nPeer::CULTURE, EmailTemplateI18nPeer::SUBJECT, EmailTemplateI18nPeer::BODY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (EmailTemplateI18nPeer::ID => 0, EmailTemplateI18nPeer::CULTURE => 1, EmailTemplateI18nPeer::SUBJECT => 2, EmailTemplateI18nPeer::BODY => 3, ),
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.EmailTemplateI18nMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = EmailTemplateI18nPeer::getTableMap();
	...
	const COUNT = 'COUNT(email_template_i18n.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT email_template_i18n.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(EmailTemplateI18nPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(EmailTemplateI18nPeer::COUNT);
		}
		...
		$rs = EmailTemplateI18nPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return EmailTemplateI18nPeer::populateObjects(EmailTemplateI18nPeer::doSelectRS($criteria, $con));
	}
	
	public static function doSelectRS(Criteria $criteria, $con = null)
	{

    foreach (sfMixer::getCallables('BaseEmailTemplateI18nPeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function populateObjects(ResultSet $rs)
	{
		$results = array();
				...
				$cls = EmailTemplateI18nPeer::getOMClass();
	...
	public static function doCountJoinEmailTemplate(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(EmailTemplateI18nPeer::ID, EmailTemplatePeer::ID);
    ...
    {
      call_user_func($callable, 'BaseEmailTemplateI18nPeer', $c, $con);
    }
		...
		$startcol = (EmailTemplateI18nPeer::NUM_COLUMNS - EmailTemplateI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		EmailTemplatePeer::addSelectColumns($c);

		$c->addJoin(EmailTemplateI18nPeer::ID, EmailTemplatePeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getEmailTemplate(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addEmailTemplateI18n($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initEmailTemplateI18ns();
    ...
    foreach (sfMixer::getCallables('BaseEmailTemplateI18nPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseEmailTemplateI18nPeer', $c, $con);
		...
		EmailTemplateI18nPeer::addSelectColumns($c);
		$startcol2 = (EmailTemplateI18nPeer::NUM_COLUMNS - EmailTemplateI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return EmailTemplateI18nPeer::CLASS_DEFAULT;
	}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof EmailTemplateI18n) {
			...
			$criteria->add(EmailTemplateI18nPeer::ID, $vals[0], Criteria::IN);
			$criteria->add(EmailTemplateI18nPeer::CULTURE, $vals[1], Criteria::IN);
		}
...
if (Propel::isInit()) {
			try {
		BaseEmailTemplateI18nPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.EmailTemplateI18nMapBuilder');
}
