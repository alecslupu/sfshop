...
/**
 * Base actions for the sfsCorePlugin sfsInformation module.
 *
 ...
 */
abstract class BasesfsInformationActions extends sfActions
{
  public function executeDetails(sfWebRequest $request)
  {
    ...
    $response->addMeta('title', $this->information->getTitle(), true, true);
