...
require_once(dirname(__FILE__).'/../lib/BasesfsInformationComponents.class.php');

/**
 * sfsInformation components.
 *
 ...
 */
class sfsInformationComponents extends BasesfsInformationComponents
{
