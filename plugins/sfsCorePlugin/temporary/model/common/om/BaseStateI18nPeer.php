...
abstract class BaseStateI18nPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(StateI18nPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(StateI18nPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}


    foreach (sfMixer::getCallables('BaseStateI18nPeer:doCount:doCount') as $callable)
    {
	...
	{
		return StateI18nPeer::populateObjects(StateI18nPeer::doSelectStmt($criteria, $con));
	}
	
	public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
	{

    foreach (sfMixer::getCallables('BaseStateI18nPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseStateI18nPeer', $criteria, $con);
    }
	...
	public static function addInstanceToPool(StateI18n $obj, $key = null)
	{
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof StateI18n) {
				$key = serialize(array((string) $value->getId(), (string) $value->getCulture()));
			} elseif (is_array($value) && count($value) === 2) {
								$key = serialize(array((string) $value[0], (string) $value[1]));
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or StateI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		$results = array();
				...
				$cls = StateI18nPeer::getOMClass(false);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = StateI18nPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = StateI18nPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				$obj = new $cls();
				$obj->hydrate($row);
				$results[] = $obj;
				StateI18nPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
	...
	public static function doCountJoinState(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(StateI18nPeer::ID,), array(StatePeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseStateI18nPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseStateI18nPeer', $criteria, $con);
		...
		StateI18nPeer::addSelectColumns($criteria);
		$startcol = (StateI18nPeer::NUM_COLUMNS - StateI18nPeer::NUM_LAZY_LOAD_COLUMNS);
		StatePeer::addSelectColumns($criteria);

		$criteria->addJoin(StateI18nPeer::ID, StatePeer::ID, $join_behavior);

		$stmt = BasePeer::doSelect($criteria, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = StateI18nPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = StateI18nPeer::getInstanceFromPool($key1))) {
															} else {
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				StateI18nPeer::addInstanceToPool($obj1, $key1);
			} 
    ...
    foreach (sfMixer::getCallables('BaseStateI18nPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseStateI18nPeer', $criteria, $con);
		...
		StateI18nPeer::addSelectColumns($criteria);
		$startcol2 = (StateI18nPeer::NUM_COLUMNS - StateI18nPeer::NUM_LAZY_LOAD_COLUMNS);
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseStateI18nPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseStateI18nPeer::TABLE_NAME))
	  {
	...
	{
		return $withPrefix ? StateI18nPeer::CLASS_DEFAULT : StateI18nPeer::OM_CLASS;
	}
    ...
    foreach (sfMixer::getCallables('BaseStateI18nPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(StateI18nPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
			...
			StateI18nPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												StateI18nPeer::clearInstancePool();
						$criteria = clone $values;
		} elseif ($values instanceof StateI18n) { 						StateI18nPeer::removeInstanceFromPool($values);
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(StateI18nPeer::ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(StateI18nPeer::CULTURE, $value[1]));
				$criteria->addOr($criterion);
								StateI18nPeer::removeInstanceFromPool($value);
			}
		}
	...
	public static function retrieveByPK($id, $culture, PropelPDO $con = null) {
		...
		$criteria = new Criteria(StateI18nPeer::DATABASE_NAME);
...
BaseStateI18nPeer::buildTableMap();
