...
class OrderItemMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('DELIVERY_ID', 'DeliveryId', 'int', CreoleTypes::INTEGER, 'delivery', 'ID', false, null);

		$tMap->addColumn('DELIVERY_METHOD_TITLE', 'DeliveryMethodTitle', 'string', CreoleTypes::VARCHAR, false, 255);
