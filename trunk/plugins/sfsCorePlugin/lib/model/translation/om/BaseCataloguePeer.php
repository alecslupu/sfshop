...
abstract class BaseCataloguePeer {
	...
	const CLASS_DEFAULT = 'plugins.sfsCorePlugin.lib.model.translation.Catalogue';
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsCorePlugin.lib.model.translation.map.CatalogueMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BaseCataloguePeer:doSelectRS:doSelectRS') as $callable)
    {
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('plugins.sfsCorePlugin.lib.model.translation.map.CatalogueMapBuilder');
}
