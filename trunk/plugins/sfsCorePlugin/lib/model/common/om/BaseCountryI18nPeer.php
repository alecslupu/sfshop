...
abstract class BaseCountryI18nPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CountryI18nPeer::ID, CountryI18nPeer::CULTURE, CountryI18nPeer::TITLE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CountryI18nPeer::ID => 0, CountryI18nPeer::CULTURE => 1, CountryI18nPeer::TITLE => 2, ),
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.CountryI18nMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = CountryI18nPeer::getTableMap();
	...
	const COUNT = 'COUNT(country_i18n.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT country_i18n.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(CountryI18nPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(CountryI18nPeer::COUNT);
		}
		...
		$rs = CountryI18nPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return CountryI18nPeer::populateObjects(CountryI18nPeer::doSelectRS($criteria, $con));
	}
	
	public static function doSelectRS(Criteria $criteria, $con = null)
	{

    foreach (sfMixer::getCallables('BaseCountryI18nPeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function doCountJoinCountry(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(CountryI18nPeer::ID, CountryPeer::ID);
    ...
    {
      call_user_func($callable, 'BaseCountryI18nPeer', $c, $con);
    }
		...
		$startcol = (CountryI18nPeer::NUM_COLUMNS - CountryI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getCountry(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addCountryI18n($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initCountryI18ns();
    ...
    foreach (sfMixer::getCallables('BaseCountryI18nPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseCountryI18nPeer', $c, $con);
		...
		CountryI18nPeer::addSelectColumns($c);
		$startcol2 = (CountryI18nPeer::NUM_COLUMNS - CountryI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return CountryI18nPeer::CLASS_DEFAULT;
	}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 {
		if ($con === null) {
			$con = Propel::getConnection(CountryI18nPeer::DATABASE_NAME);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof CountryI18n) {
			...
			$criteria->add(CountryI18nPeer::ID, $vals[0], Criteria::IN);
			$criteria->add(CountryI18nPeer::CULTURE, $vals[1], Criteria::IN);
		}
...
if (Propel::isInit()) {
			try {
		BaseCountryI18nPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.CountryI18nMapBuilder');
}
