...
abstract class BaseStatePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CountryId', 'Iso', 'TitleEnglish', 'IsActive', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_COLNAME => array (StatePeer::ID, StatePeer::COUNTRY_ID, StatePeer::ISO, StatePeer::TITLE_ENGLISH, StatePeer::IS_ACTIVE, StatePeer::CREATED_AT, StatePeer::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'country_id', 'iso', 'title_english', 'is_active', 'created_at', 'updated_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CountryId' => 1, 'Iso' => 2, 'TitleEnglish' => 3, 'IsActive' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (StatePeer::ID => 0, StatePeer::COUNTRY_ID => 1, StatePeer::ISO => 2, StatePeer::TITLE_ENGLISH => 3, StatePeer::IS_ACTIVE => 4, StatePeer::CREATED_AT => 5, StatePeer::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'country_id' => 1, 'iso' => 2, 'title_english' => 3, 'is_active' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.StateMapBuilder');
	}
    ...
    foreach (sfMixer::getCallables('BaseStatePeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function doCountJoinCountry(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(StatePeer::COUNTRY_ID, CountryPeer::ID);
    ...
    foreach (sfMixer::getCallables('BaseStatePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseStatePeer', $c, $con);
		...
		$startcol = (StatePeer::NUM_COLUMNS - StatePeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		CountryPeer::addSelectColumns($c);

		$c->addJoin(StatePeer::COUNTRY_ID, CountryPeer::ID);
    ...
    foreach (sfMixer::getCallables('BaseStatePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseStatePeer', $c, $con);
		...
		StatePeer::addSelectColumns($c);
		$startcol2 = (StatePeer::NUM_COLUMNS - StatePeer::NUM_LAZY_LOAD_COLUMNS) + 1;
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    while($rs->next()) {
      ...
      $omClass = StateI18nPeer::getOMClass($rs, $startcol);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.StateMapBuilder');
}
