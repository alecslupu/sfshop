...
function object_textarea_tag($object, $method, $options = array(), $default_value = null)
{
  ...
  $value = _get_object_value($object, $method, $default_value, null, $culture);
...
//changed by nest
function _get_object_value($object, $method, $default_value = null, $param = null, $culture = null)
{
  ...
  if ($culture != null) {
      $method[0] = str_replace('I18n', '', $method[0]);
      $method[1] = array($culture);
  }
