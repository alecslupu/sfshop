...
abstract class BaseCategoryI18nPeer {
	...
	const CLASS_DEFAULT = 'plugins.sfsCategoryPlugin.lib.model.CategoryI18n';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CategoryI18nPeer::ID, CategoryI18nPeer::CULTURE, CategoryI18nPeer::TITLE, CategoryI18nPeer::DESCRIPTION, CategoryI18nPeer::META_KEYWORDS, CategoryI18nPeer::META_DESCRIPTION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CategoryI18nPeer::ID => 0, CategoryI18nPeer::CULTURE => 1, CategoryI18nPeer::TITLE => 2, CategoryI18nPeer::DESCRIPTION => 3, CategoryI18nPeer::META_KEYWORDS => 4, CategoryI18nPeer::META_DESCRIPTION => 5, ),
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsCategoryPlugin.lib.model.map.CategoryI18nMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoryI18nPeer::META_KEYWORDS);

		$criteria->addSelectColumn(CategoryI18nPeer::META_DESCRIPTION);
    ...
    foreach (sfMixer::getCallables('BaseCategoryI18nPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCategoryI18nPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseCategoryI18nPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseCategoryI18nPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseCategoryI18nPeer', $c, $con);
    }
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('plugins.sfsCategoryPlugin.lib.model.map.CategoryI18nMapBuilder');
}
