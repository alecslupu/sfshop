...
class CategoryMapBuilder {
	...
	const CLASS_NAME = 'plugins.sfsCategoryPlugin.lib.model.map.CategoryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('PARENT_ID', 'ParentId', 'int', CreoleTypes::INTEGER, 'category', 'ID', false, null);
		...
		$tMap->addColumn('HAS_CHILD', 'HasChild', 'int', CreoleTypes::TINYINT, false, 1);
		...
		$tMap->addColumn('IS_LOCKED', 'IsLocked', 'boolean', CreoleTypes::BOOLEAN, true, null);
