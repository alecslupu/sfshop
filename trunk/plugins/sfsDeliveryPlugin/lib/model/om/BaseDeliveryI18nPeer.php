...
abstract class BaseDeliveryI18nPeer {
	...
	const TABLE_NAME = 'delivery_i18n';

	
	const CLASS_DEFAULT = 'plugins.sfsDeliveryPlugin.lib.model.DeliveryI18n';
	...
	const ID = 'delivery_i18n.ID';

	
	const CULTURE = 'delivery_i18n.CULTURE';

	
	const TITLE = 'delivery_i18n.TITLE';

	
	const DESCRIPTION = 'delivery_i18n.DESCRIPTION';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (DeliveryI18nPeer::ID, DeliveryI18nPeer::CULTURE, DeliveryI18nPeer::TITLE, DeliveryI18nPeer::DESCRIPTION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (DeliveryI18nPeer::ID => 0, DeliveryI18nPeer::CULTURE => 1, DeliveryI18nPeer::TITLE => 2, DeliveryI18nPeer::DESCRIPTION => 3, ),
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsDeliveryPlugin.lib.model.map.DeliveryI18nMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DeliveryI18nPeer::TITLE);

		$criteria->addSelectColumn(DeliveryI18nPeer::DESCRIPTION);

	}

	const COUNT = 'COUNT(delivery_i18n.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT delivery_i18n.ID)';
    ...
    foreach (sfMixer::getCallables('BaseDeliveryI18nPeer:doSelectRS:doSelectRS') as $callable)
    {
      call_user_func($callable, 'BaseDeliveryI18nPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseDeliveryI18nPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseDeliveryI18nPeer', $c, $con);
    }
		...
		$startcol = (DeliveryI18nPeer::NUM_COLUMNS - DeliveryI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getDelivery(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addDeliveryI18n($obj1); 					break;
				}
			}
			if ($newObject) {
    ...
    foreach (sfMixer::getCallables('BaseDeliveryI18nPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseDeliveryI18nPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof DeliveryI18n) {
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			Propel::registerMapBuilder('plugins.sfsDeliveryPlugin.lib.model.map.DeliveryI18nMapBuilder');
}
