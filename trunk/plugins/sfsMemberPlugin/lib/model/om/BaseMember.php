...
abstract class BaseMember extends BaseObject  implements Persistent {
	...
	public function setGender($v)
	{
		...
		if ($this->gender !== $v) {
			$this->gender = $v;
			$this->modifiedColumns[] = MemberPeer::GENDER;
		}
	...
	public function setPhone($v)
	{
		...
		if ($this->phone !== $v) {
			$this->phone = $v;
			$this->modifiedColumns[] = MemberPeer::PHONE;
		}
	...
	public function setMobile($v)
	{
		...
		if ($this->mobile !== $v) {
			$this->mobile = $v;
			$this->modifiedColumns[] = MemberPeer::MOBILE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->default_address_id = $rs->getInt($startcol + 6);

			$this->secret_question = $rs->getString($startcol + 7);

			$this->secret_answer = $rs->getString($startcol + 8);
			...
			$this->confirm_code = $rs->getString($startcol + 12);

			$this->is_confirmed = $rs->getBoolean($startcol + 13);

			$this->is_deleted = $rs->getBoolean($startcol + 14);

			$this->is_active = $rs->getBoolean($startcol + 15);

			$this->access_num = $rs->getInt($startcol + 16);

			$this->created_at = $rs->getTimestamp($startcol + 17, null);

			$this->updated_at = $rs->getTimestamp($startcol + 18, null);

			$this->modified_at = $rs->getTimestamp($startcol + 19, null);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getDefaultAddressId(),
			$keys[7] => $this->getSecretQuestion(),
			$keys[8] => $this->getSecretAnswer(),
			$keys[9] => $this->getPhone(),
			$keys[10] => $this->getMobile(),
			$keys[11] => $this->getPassword(),
			$keys[12] => $this->getConfirmCode(),
			$keys[13] => $this->getIsConfirmed(),
			$keys[14] => $this->getIsDeleted(),
			$keys[15] => $this->getIsActive(),
			$keys[16] => $this->getAccessNum(),
			$keys[17] => $this->getCreatedAt(),
			$keys[18] => $this->getUpdatedAt(),
			$keys[19] => $this->getModifiedAt(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setDefaultAddressId($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setSecretQuestion($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setSecretAnswer($arr[$keys[8]]);
		...
		if (array_key_exists($keys[12], $arr)) $this->setConfirmCode($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setIsConfirmed($arr[$keys[13]]);
		...
		if (array_key_exists($keys[16], $arr)) $this->setAccessNum($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setCreatedAt($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setUpdatedAt($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setModifiedAt($arr[$keys[19]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MemberPeer::GENDER)) $criteria->add(MemberPeer::GENDER, $this->gender);
		...
		if ($this->isColumnModified(MemberPeer::PHONE)) $criteria->add(MemberPeer::PHONE, $this->phone);
		if ($this->isColumnModified(MemberPeer::MOBILE)) $criteria->add(MemberPeer::MOBILE, $this->mobile);
