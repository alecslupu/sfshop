<form action="<?php echo url_for('@product_search'); ?>" method="post" name="form_search_short" class="form form_search_short">
    <table cellspacing="0" cellpadding="0">
       <tr>
          <td width="4" height="37" background="<?php echo sfConfig::get('app_sfshop_core_images_dir')?>m3.gif"></td>
          <td width="248" height="37" background="<?php echo sfConfig::get('app_sfshop_core_images_dir')?>m4.gif" class="ML4-W" style="padding-top: 3px;">
