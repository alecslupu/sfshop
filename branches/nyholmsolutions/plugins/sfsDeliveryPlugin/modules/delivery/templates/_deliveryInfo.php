<div id="container_info_delivery" class="container_info">
    ...
    <span class="price" <?php echo $deliveryService['price'] != '' ? '' : 'style="display: none"' ?>><?php echo format_currency($deliveryService['price'],isset($deliveryService['currency_id']) ? $deliveryService['currency_id'] : null, false,isset($noCurrencyConversion) ? $noCurrencyConversion : false) ?></span>
</div>
<?php if (isset($is_edit_enabled) && $is_edit_enabled): ?>
