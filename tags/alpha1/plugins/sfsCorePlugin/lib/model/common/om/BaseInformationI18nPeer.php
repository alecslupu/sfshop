...
abstract class BaseInformationI18nPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (InformationI18nPeer::ID, InformationI18nPeer::CULTURE, InformationI18nPeer::TITLE, InformationI18nPeer::DESCRIPTION, InformationI18nPeer::META_KEYWORDS, InformationI18nPeer::META_DESCRIPTION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (InformationI18nPeer::ID => 0, InformationI18nPeer::CULTURE => 1, InformationI18nPeer::TITLE => 2, InformationI18nPeer::DESCRIPTION => 3, InformationI18nPeer::META_KEYWORDS => 4, InformationI18nPeer::META_DESCRIPTION => 5, ),
	...
	{
		return BasePeer::getMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.InformationI18nMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = InformationI18nPeer::getTableMap();
	...
	const COUNT = 'COUNT(information_i18n.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT information_i18n.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(InformationI18nPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(InformationI18nPeer::COUNT);
		}
		...
		$rs = InformationI18nPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return InformationI18nPeer::populateObjects(InformationI18nPeer::doSelectRS($criteria, $con));
	}
	
	public static function doSelectRS(Criteria $criteria, $con = null)
	{

    foreach (sfMixer::getCallables('BaseInformationI18nPeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function populateObjects(ResultSet $rs)
	{
		$results = array();
				...
				$cls = InformationI18nPeer::getOMClass();
	...
	public static function doCountJoinInformation(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(InformationI18nPeer::ID, InformationPeer::ID);
	...
	public static function doSelectJoinInformation(Criteria $c, $con = null)
	{

    foreach (sfMixer::getCallables('BaseInformationI18nPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseInformationI18nPeer', $c, $con);
    }
		...
		$startcol = (InformationI18nPeer::NUM_COLUMNS - InformationI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		InformationPeer::addSelectColumns($c);

		$c->addJoin(InformationI18nPeer::ID, InformationPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getInformation(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addInformationI18n($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initInformationI18ns();
    ...
    foreach (sfMixer::getCallables('BaseInformationI18nPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseInformationI18nPeer', $c, $con);
		...
		InformationI18nPeer::addSelectColumns($c);
		$startcol2 = (InformationI18nPeer::NUM_COLUMNS - InformationI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

		InformationPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + InformationPeer::NUM_COLUMNS;
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return InformationI18nPeer::CLASS_DEFAULT;
	}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof InformationI18n) {
			...
			$criteria->add(InformationI18nPeer::ID, $vals[0], Criteria::IN);
			$criteria->add(InformationI18nPeer::CULTURE, $vals[1], Criteria::IN);
		}
...
if (Propel::isInit()) {
			try {
		BaseInformationI18nPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('plugins.sfsCorePlugin.lib.model.common.map.InformationI18nMapBuilder');
}
