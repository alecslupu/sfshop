...
class MemberMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('PRIMARY_PHONE', 'PrimaryPhone', 'string', CreoleTypes::VARCHAR, false, 32);

		$tMap->addColumn('SECONDARY_PHONE', 'SecondaryPhone', 'string', CreoleTypes::VARCHAR, false, 32);
