...
abstract class BaseCategoryI18n extends BaseObject  implements Persistent {
	...
	public function setMetaKeywords($v)
	{
		...
		if ($this->meta_keywords !== $v) {
			...
			$this->modifiedColumns[] = CategoryI18nPeer::META_KEYWORDS;
		}
	...
	public function setMetaDescription($v)
	{
		...
		if ($this->meta_description !== $v) {
			...
			$this->modifiedColumns[] = CategoryI18nPeer::META_DESCRIPTION;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoryI18nPeer::META_KEYWORDS)) $criteria->add(CategoryI18nPeer::META_KEYWORDS, $this->meta_keywords);
		if ($this->isColumnModified(CategoryI18nPeer::META_DESCRIPTION)) $criteria->add(CategoryI18nPeer::META_DESCRIPTION, $this->meta_description);
